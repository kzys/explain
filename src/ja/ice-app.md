...
Ice はメニューバーの表示項目を、常に表示するものと普段は隠すものに分類できるアプリケーションだ。この種のアプリケーションでは [Bartender](https://www.macbartender.com/) が長らく定番だったようだけど、[Bartender は2024年にオーナーが変わってしまって](https://www.macrumors.com/2024/06/04/bartender-mac-app-new-owner/)、私はちょっと将来を不安視している。その点、Ice は GPLv3 のフリーソフトウェアなので、安心できる。
